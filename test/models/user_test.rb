...
class UserTest < ActiveSupport::TestCase
  ...
  test "rejects invalid phone format" do
    # After normalization "123" becomes "+123" (too short for E.164; need 7–14 digits after +[1-9])
    u = User.new(phone_number: "123", email: "", password: "password123", password_confirmation: "password123")
    refute u.valid?
