...
Doorkeeper::OpenidConnect.configure do
  ...
  # RSA private key for signing OIDC ID tokens (shared with JWT access tokens in 00_oauth_signing_key.rb).
  signing_key defined?(OIDC_PRIVATE_KEY_PEM) ? OIDC_PRIVATE_KEY_PEM : (raise "OIDC_PRIVATE_KEY_PEM not set; check 00_oauth_signing_key.rb")
